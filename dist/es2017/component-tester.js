    ...
    create(bootstrap) {
        return bootstrap(async (aurelia) => {
            ...
            if (this.stubbed.size > 0) {
                ...
                aurelia.loader.loadTemplate = async function (url) {
                    const entry = await originalLoadtemplate.call(this, url);
...
const overrideHtmlBehaviorResourceLoad = () => {
    if (HtmlBehaviorResource.prototype.load === originalLoad) {
        HtmlBehaviorResource.prototype.load = async function (container, 
